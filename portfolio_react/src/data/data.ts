...
export const data = {
    fr: {
        "presentation": "<span class='text-bolder'>Développeur étudiant</span> en 3e année de BUT informatique, passionné par la création de <span class='text-bolder'>sites web</span> et d'<span class='text-bolder'>applications</span>, prêt à céer le",
    ...
    en: {
        "presentation": "Third-year <span class='text-bolder'>computer science student</span>, passionate about creating <span class='text-bolder'>websites</span> and <span class='text-bolder'>applications</span>, ready to shape the",
        ...
        [
            ...
            [
                ...
                "During my team-based VueJS e-commerce website development project at USMB, four key points are worth highlighting :<ul><li><span class='text-bolder'>Use of the VueJS Framework :</span> Development of a website using the VueJS JavaScript framework.</li><li><span class='text-bolder'>Implementation of a Rest API :</span> Design and development of a C# Rest API to control communication between the website and the database.</li><li><span class='text-bolder'>Integration of Unit Tests and Moq :</span> Development of unit tests for the website and the Rest API, followed by enhancements to API tests using the C# Moq Nuget package, which simulates unit tests without injecting data into the database.</li><li><span class='text-bolder'>Creation of a Database :</span> Design of conceptual data models to anticipate potential issues and ensure the creation of a well-structured database using PostgreSQL.</li></ul>"
            ],
            [
                "USMB - Study project",
                USMB,
                ...
                "During my team-based PHP Laravel e-commerce website development project at USMB, four key points are worth highlighting :<ul><li><span class='text-bolder'>Use of the VueJS Framework :</span> Development of a website using the Laravel PHP framework.</li><li><span class='text-bolder'>Implementation of a Rest API :</span> Design and development of a C# Rest API to control communication between the website and the database.</li><li><span class='text-bolder'>Integration of Unit Tests and Moq :</span> Development of unit tests for the website and the Rest API, followed by enhancements to API tests using the C# Moq Nuget package, which simulates unit tests without injecting data into the database.</li><li><span class='text-bolder'>Creation of a Database :</span> Design of conceptual data models to anticipate potential issues and ensure the creation of a well-structured database using PostgreSQL.</li></ul>"
            ],
            [
                "C-Gastronomie",
                C_Gastro,
